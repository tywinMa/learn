const { Exercise, Subject, sequelize } = require('../models');
...
const addUnit1_1Exercises = async () => {
  try {
    ...
    const unitId = 'math-1-1'; // 数学学科的第一阶段第一部分
