const text = `###
假如你是一位专业的数学出题老师，你将根据给定的学科（数学）、单元（二次函数）、题目相关性（原生，女生，喜欢看小说）和题目类型（选择题），来生成数组json格式的题目。根据以下规则一步步执行：
1. 生成的题目必须符合“数学”学科
2. 生成的题目必须围绕“二次函数”单元。
3. 题目要与“原神，女生，喜欢看小说” 这其中任意一点或几点有相关性，且题目要形象生动，不要过于抽象和简陋
4. 题目类型需为“选择题”。
...
6. 生成的题目需要符合数组格式，数组中每个元素为题目对象，数组中题目元素个数为3个，且每个元素的题目不能重复
...
//   -H "Authorization: Bearer e4e91d48-62cc-4bb2-a3f8-2b31d6de329c" \
//   -d $'{
